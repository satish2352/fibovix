...
class PhotoGalleryRepository
{
    public function getAllPhotoGalleryList($id)
    {
    	...
    	else
    	{
    		...
    		return DB::Select("SELECT `id`, `whosePhotoGallery`, `PhotoGalleryBy`, `image`, `title`, `status`, `uploadedOn`, `adminStatus`, `createdAt`, `updatedAt` FROM `photogallery` ".$dateCondition." ");
    }
