...
class CommonRepository
{
    ...
    public function getAllcity()
    {
         ...
         $stId = DB::select("SELECT stateID FROM pilotregistration where id='$pilotId' ");
         $sId=$stId[0]->stateID;
        
        $result = DB::select("SELECT id, city_code, state_id, name, created_at, updated_at FROM cities where state_id='$sId'  ");
    ...
    public function getFTOList($approvedOrDis)
    {
        ...
        $result = DB::select("SELECT `id`, `FTOName`, `FTOLogo`, `firstName`, `middleName`, `lastName`, `email`, `password`, `mobile`, `adharNumber`, `proffession`, `stateID`, `cityId`, `district`, `description`, `address1`, `address2`, `address3`, `pinCode`, `drivingLicence`, `eduQualification`, `passportPhoto`, `sentOtp`, `otpVerified`, `status`, `rating`, `adminApproved`, `entryBy`, `createdAt`, `updatedAt` FROM `ftoregistration` ".$condition." ");
    ...
    {
    	return DB::select("SELECT `id`, `firstName`,`FTOName`, `FTOLogo`, `middleName`, `lastName`, `email`, `password`, `mobile`, `adharNumber`, `proffession`, `stateID`, `cityId`, `description`, `address1`, `address2`, `address3`, `pinCode`, `drivingLicence`, `eduQualification`, `passportPhoto`, `sentOtp`, `otpVerified`, `status`, `adminApproved`, `entryBy`, `createdAt`, `updatedAt` FROM `ftoregistration` WHERE id=".$ftoId." ");
    }
    ...
    {   
        ...
        {
            $condition = "WHERE `id` = '".$contentId."' ";
        }
        return DB::Select("SELECT `id`, `bondContent`, `status` FROM `bondcontent`  ".$condition."");
    }
