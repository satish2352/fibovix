<?php
namespace App\Http\Controllers\FTO\VideoGallery;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use App\Http\Service\FTO\VideoGallery\VideoGalleryService;
class VideoGalleryController extends Controller
{
   ...
   public function index()
   {
       $allVideoGallery=$this->service->getAllVideoGalleryList('');
   		return view('fto.videogallery.videogallery',compact('allVideoGallery'));
   }
