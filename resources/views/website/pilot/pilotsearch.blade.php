...
<div class="row text-center justify-content-center" style="margin-top: 15px;">
      <div class="col-md-12">
          <h1 class=" text-uppercase text-primary">PILOT SEARCH</h1>
...
<div class="container my-5">
    ...
    <div class="card-body">
            ...
            <td>@if($getallPilots->oannumber) {{$getallPilots->oannumber }} @else{{'NA'}} @endif</td>
            <td><?php $result=DB::select("SELECT * FROM `pilotrdroneinfo` WHERE `pilotId`='".$getallPilots->pilotIdFInal."'"); ?>
            @if(count($result))
                @foreach($result as $key=>$pilotDrone)
                    @if($pilotDrone->uaopnumber!='')
    ...
    <!--<div class="slider gallery gallery-responsive portfolio_slider">-->
    <!--    @foreach($allPilotsAdvertise as $getallPilotsAdvertise)-->
    <!--    <img src="<?php echo env('APP_URL');?>public/asset/Advertise/Image/{{$getallPilotsAdvertise->image}}" alt="{{$getallPilotsAdvertise->title}}" style="width:100%;height: 212px;"> @endforeach-->
    <!--</div>-->
