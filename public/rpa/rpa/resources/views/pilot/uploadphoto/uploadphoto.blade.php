								...
								<tr>
									...
									<td>
								        @if ($getallPhoto->status == "1")
								            <a class="btn btn-success" href="{{route('photoshowhidebypilot',array('id'=>$getallPhoto->id,'approvalVal'=>$getallPhoto->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('photoshowhidebypilot',array('id'=>$getallPhoto->id,'approvalVal'=>$getallPhoto->status))}}" role="button" >
