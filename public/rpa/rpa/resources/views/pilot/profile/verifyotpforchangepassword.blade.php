			...
			<div class="min-height-200px">
				...
				<div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
					...
					<div class="row table-responsive " style="overflow: hidden;">
                     ...
                     <form action="{{route('updatepilotchangepassword')}}" method="POST" class="mb-5" enctype="multipart/form-data">
                            @csrf
                            <div class="form-row justify-content-between">
                                    <div class="form-group col-md-12">
                                      <center> <label for=""><span class="text-primary">* OTP Sent on Your Registered Mobile Number</span></label></center>
                                    </div>
                            </div>
                                ...
                                <div class="form-row justify-content-between">
                                   ...
                                   <div class="form-group col-md-4">
                                        ...
                                        <input name="enteringotp" type="text" class="form-control" id="enteringotp"
                                               placeholder="Provide OTP" value="" required>
                                               
                                        <input name="receivedotp" type="text" class="form-control" id="receivedotp"
                                                value="{{$sentOtpforpassword}}" hidden>
                                               
                                        <input name="mobile" type="text" class="form-control" id="newMobile"
                                                value="{{$mobile}}" hidden>
                                                
                                        <input name="newPassword" type="text" class="form-control" id="newPassword"
                                                value="{{$changeingPassword}}" hidden>
                                    </div>
                                    <div class="form-group col-md-4">
