								...
								<tr>
									...
									<td>
								        @if ($getallAchievement->status == "1")
								            <a class="btn btn-success" href="{{route('achievementshowhidebypilot',array('id'=>$getallAchievement->id,'approvalVal'=>$getallAchievement->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('achievementshowhidebypilot',array('id'=>$getallAchievement->id,'approvalVal'=>$getallAchievement->status))}}" role="button" >
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <form action="{{route('saveachievement')}}" method="POST" enctype="multipart/form-data">
					    @csrf
