								...
								<tr>
									...
									<td>
								        @if ($getallAdvertise->status == "1")
								            <a class="btn btn-success" href="{{route('advertiseshowhidebypilot',array('id'=>$getallAdvertise->id,'approvalVal'=>$getallAdvertise->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('advertiseshowhidebypilot',array('id'=>$getallAdvertise->id,'approvalVal'=>$getallAdvertise->status))}}" role="button" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<!--<form method="post" enctype="multipart/form-data">-->
        	    <form action="{{route('saveadvertise')}}" method="POST" enctype="multipart/form-data">
					    @csrf
