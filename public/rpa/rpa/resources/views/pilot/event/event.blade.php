								...
								<tr>
									...
									<td>
								        @if ($getallEvent->status == "1")
								            <a class="btn btn-success" href="{{route('eventshowhidebypilot',array('id'=>$getallEvent->id,'approvalVal'=>$getallEvent->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('eventshowhidebypilot',array('id'=>$getallEvent->id,'approvalVal'=>$getallEvent->status))}}" role="button" >
