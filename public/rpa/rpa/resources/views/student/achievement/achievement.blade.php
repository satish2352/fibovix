						...
						<table class="table table-striped" id="pageDataTable" role="grid" aria-describedby="DataTables_Table_0_info">
							...
							<tbody>
								...
								<tr>
									...
									?>
									<td>
									    <img src="public/asset/Achievement/Image/{{$getallAchievement->image}}" height="100" width="100">
									</td>
									<?php
									}
									else
									...
									?>
									  <td>
									      <img src="public/asset/no-image-available.png" height="100" width="100">
									  </td>
									<?php
									}
									?>
									...
									<td>
								        @if ($getallAchievement->status == "1")
								            <a class="btn btn-success" href="{{route('achievementshowhidebyfto',array('id'=>$getallAchievement->id,'approvalVal'=>$getallAchievement->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('achievementshowhidebyfto',array('id'=>$getallAchievement->id,'approvalVal'=>$getallAchievement->status))}}" role="button" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<!--<form method="post" enctype="multipart/form-data">-->
        	    <form action="{{route('saveftoachievement')}}" method="POST" enctype="multipart/form-data">
					    @csrf
					    ...
					    <div class="form-group row">
							...
							<div class="col-sm-12 col-md-11">
								<input class="form-control date-picker" name="achievedDate" id="" required="" placeholder="Choose Achievement Date" type="text" autocomplete="off">
							</div>
						</div>
