						...
						<table class="table table-striped" id="pageDataTable" role="grid" aria-describedby="DataTables_Table_0_info">
							...
							<tbody>
								...
								<tr>
									...
									?>
									<td>
									    <img src="public/asset/Advertise/Image/{{$getallAdvertise->image}}" height="100" width="100">
									</td>
									<?php
									}
									else
									...
									<td>
								        @if ($getallAdvertise->status == "1")
								            <a class="btn btn-success" href="{{route('advertiseshowhidebyfto',array('id'=>$getallAdvertise->id,'approvalVal'=>$getallAdvertise->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('advertiseshowhidebyfto',array('id'=>$getallAdvertise->id,'approvalVal'=>$getallAdvertise->status))}}" role="button" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<!--<form method="post" enctype="multipart/form-data">-->
        	    <form action="{{route('saveftoadvertise')}}" method="POST" enctype="multipart/form-data">
					    @csrf
