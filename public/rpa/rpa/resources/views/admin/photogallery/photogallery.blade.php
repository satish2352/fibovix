						...
						<table class="table table-striped" id="pageDataTable" role="grid" aria-describedby="DataTables_Table_0_info">
							...
							<tbody>
								...
								<tr>
									...
									<td>
								        @if ($getallPhoto->PhotoGalleryBy == "0")
								            <span>Pilot</span>
								        @elseif ($getallPhoto->PhotoGalleryBy == "1")
								            <span>FTO</span>
								        @else
								            <span>Admin</span>
                                        @endif
									...
									<td>
								        @if ($getallPhoto->status == "1")
								            <a class="btn btn-success" href="{{route('photoshowhidebyadmin',array('id'=>$getallPhoto->id,'approvalVal'=>$getallPhoto->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('photoshowhidebyadmin',array('id'=>$getallPhoto->id,'approvalVal'=>$getallPhoto->status))}}" role="button" >
								    ...
								    <td>
								        @if ($getallPhoto->PhotoGalleryBy != "2")
								        
								        @if ($getallPhoto->adminStatus == "1")
								            <a class="btn btn-success" href="{{route('photoapprovalbyadmin',array('id'=>$getallPhoto->id,'approvalVal'=>$getallPhoto->adminStatus))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('photoapprovalbyadmin',array('id'=>$getallPhoto->id,'approvalVal'=>$getallPhoto->adminStatus))}}" role="button" >
									            <i class="fa fa-thumbs-down"></i>
								            </a>
                                        @endif
                                        @endif
