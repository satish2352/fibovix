      ...
      <div class="min-height-200px">
        ...
        <div class="pd-20 bg-white border-radius-4 box-shadow mb-30">
          <div class="clearfix mb-20">
            <div class="pull-left">
              <h5 class="text-blue">Service Category List</h5>
            </div>
          </div>
              ...
              <tbody>
                  @foreach($allState as $key=>$value)
                                <tr>
                                    ...
                                    <td>
                                      <a href="{{route('servicecategory',['categoryId'=>$value->id,'deleteOrEditState'=>'editstate'])}}" class="btn btn-edit btn-lg">
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title" id="myModalLabel"><center>Add Service Category</center></h4>
      </div>
      <div class="modal-body">
              ...
              <div class="col-sm-12 col-md-11">
                ...
                <input class="form-control" type="text" name="" id="categoryName" placeholder="Enter Service Catogory Name" value="@if($allStateForEdit){{$allStateForEdit[0]->servicecategory}}@endif" required="" >
  ...
  var categoryId=$("#categoryId"). val();
   ...
   if(editedOrFreshEntries!=1)
   {
    ...
    swal({
          ...
          if (isConfirm) {
            swal({
              title: 'Service Category Saved!',
              text: 'Service Category Saved successfully!',
              icon: 'success'
            }).then(function() {
              
                        var url =APP_URL+'/servicecategory';
                        $.ajax({
