...
<div class="container my-5">
    ...
    <!--    <img src="<?php //echo env('APP_URL');?>public/asset/Advertise/Image/{{$getallPilotsAdvertise->image}}" alt="{{$getallPilotsAdvertise->title}}" style="width:850px;height: 250px;"> @endforeach-->
    <!--</div>-->
            ...
            <div class="row">
                ...
                <div class="form-group col-s-3">
                    ...
                    <select class="form-control" name="course" required="" id="course" onchange="getResult();" class="custom-select col-12">
                        ...
                        <option value="{{$getallCourses->id}}">{{$getallCourses->courseName}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-s-3">
                    ...
                    <select class="form-control" name="courseDuration" required="" id="courseDuration" onchange="getResult();" class="custom-select col-12">
                        ...
                        @foreach($courseDuration as $courseDurationNew )

                        <option value="{{$courseDurationNew->id}}">{{$courseDurationNew->duration}}</option>
                        @endforeach
                    </select>
                </div>
                ...
                <div class="form-group col-s-3">
                    ...
                    <select class="form-control" name="category" required="" id="category" onchange="getResult();" class="custom-select col-12">
            ...
            <div id="tableAjax">
                <div class="row table-responsive ">
                    <table class="table table-hover" id="pageDataTable" role="grid" aria-describedby="DataTables_Table_0_info" style="border: none;">
                        ...
                        <tbody>
                            @if(count($allCourses) > 0) @foreach($allCourses as $getallCourses )
                                            ...
                                            <div class="row no-gutters">
                                                <div class="col-md-6 courses-card-image">
                                                    <center>
                                                        ...
                                                        <img src="<?php echo env('APP_URL'); ?>public/asset/Course/Image/{{$getallCourses->image}}" style="height: 150px; width: 200px; margin-top: 10px"> @else
                                                        <img src="<?php echo env('APP_URL'); ?>public/asset/noImage.png" style="height: 150px; width: 200px; margin-top: 10px"> @endif
                                                    </center>
                                                </div>
                                                <div class="col-md-6">
                                                    <div class="card-body">
                                                        ...
                                                        <p class="card-text1">State:
                                                            <?php $state=$CommonService->getPerticularAdminStateById($getallCourses->state);?> {{$state[0]->state}}</p>
                                                        <p class="card-text1">City:
                                                            <?php $city=$CommonService->getPerticularAdminCityById($getallCourses->city);?> {{$city[0]->city}}</p>
    ...
    <!--<div class="slider gallery gallery-responsive portfolio_slider">-->
    <!--    @foreach($allPilotsAdvertise as $getallPilotsAdvertise)-->
    <!--    <img src="<?php //echo  env('APP_URL');?>public/asset/Advertise/Image/{{$getallPilotsAdvertise->image}}" alt="{{$getallPilotsAdvertise->title}}" style="width:100%;height:150px"> @endforeach-->
    <!--</div>-->
</div>
