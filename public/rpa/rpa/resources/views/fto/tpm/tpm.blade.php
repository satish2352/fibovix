								...
								<tr>
									...
									<td>
								        @if ($getallTPM->status == "1")
								            <a class="btn btn-success" href="{{route('tpmshowhidebyfto',array('id'=>$getallTPM->id,'approvalVal'=>$getallTPM->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('tpmshowhidebyfto',array('id'=>$getallTPM->id,'approvalVal'=>$getallTPM->status))}}" role="button" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<!--<form method="post" enctype="multipart/form-data">-->
        	    <form action="{{route('saveftotpm')}}" method="POST" enctype="multipart/form-data">
					    @csrf
