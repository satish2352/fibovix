                     	...
                     	<table class="table table-striped" id="pageDataTable" role="grid" aria-describedby="DataTables_Table_0_info">
							...
							<tbody>
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('ftoinstrctorlistbyfto',['ftoInstructorId'=>$value->id,'deleteOrEditState'=>'editstate'])}}" class="btn btn-edit btn-xs">
                                        <i class="icon-copy fi-pencil btngreen" title="Edit"></i>
                                      </a>
                                        <button onclick="deleteState({{$value->id}})" class="btn btn-delete btn-xs"><i class="icon-copy fi-trash btndelete" title="Delete"></i></button>
