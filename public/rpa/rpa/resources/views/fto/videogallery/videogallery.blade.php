								...
								<tr>
									...
									<td>
								        @if ($getallVideo->status == "1")
								            <a class="btn btn-success" href="{{route('videoshowhidebyfto',array('id'=>$getallVideo->id,'approvalVal'=>$getallVideo->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('videoshowhidebyfto',array('id'=>$getallVideo->id,'approvalVal'=>$getallVideo->status))}}" role="button" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<!--<form method="post" enctype="multipart/form-data">-->
        	    <form action="{{route('saveftovideo')}}" method="POST" enctype="multipart/form-data">
					    @csrf
