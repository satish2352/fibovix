								...
								<tr>
									...
									<td>
								        @if ($getallBlog->status == "1")
								            <a class="btn btn-success" href="{{route('blogshowhidebyfto',array('id'=>$getallBlog->id,'approvalVal'=>$getallBlog->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('blogshowhidebyfto',array('id'=>$getallBlog->id,'approvalVal'=>$getallBlog->status))}}" role="button" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<!--<form method="post" enctype="multipart/form-data">-->
        	    <form action="{{route('saveftoblog')}}" method="POST" enctype="multipart/form-data">
					    @csrf
