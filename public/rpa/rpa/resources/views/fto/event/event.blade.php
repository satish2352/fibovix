								...
								<tr>
									...
									<td>
								        @if ($getallEvent->status == "1")
								            <a class="btn btn-success" href="{{route('eventshowhidebyfto',array('id'=>$getallEvent->id,'approvalVal'=>$getallEvent->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('eventshowhidebyfto',array('id'=>$getallEvent->id,'approvalVal'=>$getallEvent->status))}}" role="button" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<!--<form method="post" enctype="multipart/form-data">-->
        	    <form action="{{route('saveftoevent')}}" method="POST" enctype="multipart/form-data">
					    @csrf
