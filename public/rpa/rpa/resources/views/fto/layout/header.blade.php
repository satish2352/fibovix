...
<div class="left-side-bar">
		...
		<div class="menu-block customscroll">
			<div class="sidebar-menu">
				<ul id="accordion-menu">
				    ...
				    <li>
						<a href="{{route('dashfto')}}" class="dropdown-toggle no-arrow">
					...
					<li class="dropdown ">
						<a href="javascript:;" class="dropdown-toggle" data-option="on">
							<span class="fa fa-book"></span><span class="mtext">Course</span>
						</a>
						<ul class="submenu">
							<li><a href="{{route('ftocourseslist')}}">Courses</a></li>
							<li><a href="{{route('ftocoursesdatelist')}}">Course Date</a></li>
						</ul>
					</li>
					...
					<li>
						<a href="{{route('ftoregisteredstudentslist')}}" class="dropdown-toggle no-arrow">
							<span class="fa fa-user"></span><span class="mtext">Registered Students</span>
						</a>
					</li>
					...
					<li class="dropdown ">
						...
						<ul class="submenu" >
							<li><a href="{{route('ftocertificategeneratecodelist')}}">Create Certificate Number</a></li>  
							<!--ftoinstructorrating-->
							<li><a href="{{route('ftoprovidestudentcertificatelist')}}">Certificate</a></li>
							<!--ftopilotrating-->
					...
					<li>
						<a href="{{route('ftonewslist')}}" class="dropdown-toggle no-arrow">
					...
					<li class="dropdown ">
						...
						<ul class="submenu">
							<li><a href="{{route('ftophotolist')}}">Photo</a></li>
							<li><a href="{{route('ftovideolist')}}">Video</a></li>
							<li><a href="{{route('ftotpmlist')}}">Training Process Manual</a></li>
						</ul>
					</li>
	...
	<!-- end Sidebar -->
@yield('content')
@extends('fto.layout.toast')
@extends('fto.layout.footer')
