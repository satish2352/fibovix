								...
								<tr>
									...
									<td>
								        @if ($getallNews->status == "1")
								            <a class="btn btn-success" href="{{route('newsshowhidebyfto',array('id'=>$getallNews->id,'approvalVal'=>$getallNews->status))}}" role="button" >
									            <i class="fa fa-thumbs-up"></i>
								            </a>
								            
								        @else
								            <a class="btn btn-danger" href="{{route('newsshowhidebyfto',array('id'=>$getallNews->id,'approvalVal'=>$getallNews->status))}}" role="button" >
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        	<!--<form method="post" enctype="multipart/form-data">-->
        	    <form action="{{route('saveftonews')}}" method="POST" enctype="multipart/form-data">
					    @csrf
