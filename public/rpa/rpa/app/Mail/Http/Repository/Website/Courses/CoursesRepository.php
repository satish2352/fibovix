...
class CoursesRepository
{
    public function getAllCoursesList()
    {
        ...
        $result = DB::select("SELECT `id`, `category`, `courseName`, `description`, `duration`, `price`, `commission`, `state`, `city`, `image`, `pdf`, `createdBy`, `status`, `createdAt`, `updatedAt` FROM `courses` ");
