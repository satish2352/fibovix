...
namespace App\Http\Controllers\Admin\Master\ServiceCategory;
use Illuminate\Http\Request;
use App\Http\Controllers\Controller;
use App\Http\Service\Admin\Master\ServiceCategory\ServiceCategoryService;
    ...
    public function index(Request $req){
        ...
        if(isset($req->deleteOrEditState))
        {
            ...
            if($req->deleteOrEditState=='editstate')
            {
                ...
                return view('admin/master/servicecategory/servicecategory',compact('allState','allStateForEdit','openModal'));
