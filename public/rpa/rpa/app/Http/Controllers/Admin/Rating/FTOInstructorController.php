...
use App\Http\Service\Admin\Rating\FTOInstructorService;
...
class FTOInstructorController extends Controller
{
    ...
    // 	}
    	...
    	$openModal=0;
        return view('admin/rating/instructor',compact('allState','allStateForEdit','openModal'));
    ...
    public function ftoInstructorRating($id,$instructorRating)
   {
        ...
        return redirect('adminstructorrate');
   }
