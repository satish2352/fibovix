...
class FTORepository
{
    ...
    public function getAllFTOForSearchPageAfterSomeStateCityChange($stateId,$cityId)
    {
        ...
        $result=DB::select("SELECT f.id as ftoIdFInal,f.FTOName,f.FTOLogo,f.firstName,f.middleName,f.lastName,f.address1,f.address2,f.address3,f.pinCode,f.email,f.mobile,f.stateID,f.cityId,f.status,f.adminApproved,f.entryBy,f.createdAt,f.updatedAt
