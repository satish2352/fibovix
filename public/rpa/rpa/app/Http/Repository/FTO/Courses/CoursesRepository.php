...
class CoursesRepository
{
    public function getAllCoursesList($id)
    {
    	...
    	return DB::Select("SELECT `id`, `category`, `courseName`, `description`, `duration`, `price`, `commission`, `state`, `city`, `image`, `pdf`, `createdBy`, `status`, `createdAt`, `courseownerid`, `updatedAt` FROM `courses` WHERE `courseownerid`= ".$FTOId." and `createdBy`='0' ".$dateCondition." ");
    }
