...
class VideoGalleryRepository
{
    public function getAllVideoGalleryList($id)
    {
    	...
    	else
    	{
    		...
    		return DB::Select("SELECT `id`, `whoseVideoGallery`, `VideoGalleryBy`, `url`, `title`, `status`, `uploadedOn`, `adminStatus`, `createdAt`, `updatedAt` FROM `videogallery` ".$dateCondition." ");
    }
