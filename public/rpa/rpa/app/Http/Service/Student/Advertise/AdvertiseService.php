<?php
namespace App\Http\Service\FTO\Advertise;
use Illuminate\Http\Request;
use App\Http\Repository\FTO\Advertise\AdvertiseRepository;
use session;
    ...
    public function saveAdvertiseForm($req)
    {
        ...
        $AdvertiseImage=public_path()."/asset/Advertise/Image";
          ...
          else
          {
            ...
            $advertisedata=array(
            'whoadvertising'=>session()->get('ftoId'),
            'title'=>$req->adsTitle,
            'content'=>$req->adsContent,
            'advertiseBy'=>1,   // 0 Means Pilot, 1 FTO and 2 Means Admin
            'image'=>$imageName,
