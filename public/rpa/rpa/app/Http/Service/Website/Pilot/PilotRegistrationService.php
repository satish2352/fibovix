...
class PilotRegistrationService
{
    ...
    public function pilototpverified($otp)
    {
        $data=array(
                'otpVerified'=>1
            );
            
        $allpilototpverified=$this->repository->pilototpverified($otp,$data);
       
        return $allpilototpverified;
    }
    ...
    public function generateOTP($mobile)
    {
        ...
        $msg=$otp." is the OTP for your verification for Pilot registration on RPA Pilot. Regards RPA Pilot Rays Aviation";
        $ch = "RPAPLT";
